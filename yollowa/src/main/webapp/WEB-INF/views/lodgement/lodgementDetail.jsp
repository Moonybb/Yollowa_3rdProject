						...
						<div id="package-div-option">
							...
							<div class="container">
								...
								<div class="row recommendation">
									<h4>${startEndDay.getLodgement_companyName()} 근처 추천 액티비티</h4>
													...
													<div class="col-md-3 cardBox" onclick="recommendClick(this);">
														...
														<div class="card">
															<div class="recommendImgBox">
																...
																<img class="recommendImg" src="/activity/titleImg/${list.activity_img }"/>
															...
															<div class="recommendSubBox">
																<div class="recommendSub">${list.activity_title }</div>
																<div class="recommendReview">
																	<span>★ ${list.activity_reviewGradeRate } (리뷰 ${list.activity_reviewCount }건)</span>
																</div>
															</div>
														</div>
													</div>
