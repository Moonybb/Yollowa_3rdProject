								...
								<div class="col-md-2 recomment">
									...
									<div>액티비티</div>
										...
										function recommendClick(me){
											var lodgementNumber = $(me).find('.hiddenNumber').val();
											console.log(lodgementNumber);
											window.location.href="../../lodgement/detail/"+lodgementNumber;
										}
										</script>
								<div class="col-md-10 appendMent">
									...
									<c:forEach items="${recommendList }" end="3" var="list">
										<div class="col-md-3 cardBox" onclick="recommendClick(this);">
											<input type="hidden" class="hiddenNumber" value="${list.lodgement_number }" />
											<div class="card">
												<div class="recommendImgBox">
													<div class="recommendType">${list.lodgement_category }</div>
													<img class="recommendImg" src="/lodgement/titleImg/${list.lodgement_img }"/>
