        ...
        swal({
        	...
        	if(result){
        		$.ajax({
        	    	...
        	    	dataType:"json",
        	    	url:"${pageContext.request.contextPath}/activity/detail/InicisAjax",
        	    });
        	    window.location.href='http://localhost:8080/yollowa/activity/detail/ReservationResult/';
        	}
        });
