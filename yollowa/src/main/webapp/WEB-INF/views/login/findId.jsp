...
<script type="text/javascript">
	...
	function find(f){
		...
		var list ="name="+name+"&phoneNumber="+pn;
		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="${pageContext.request.contextPath }/login/result" method="post">
					<span class="login100-form-title p-b-49" style="font-family: 'MapoPeacefull';"> 아이디 찾기 </span>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" type="button" style="font-family: 'MapoPeacefull';" onclick="find(this);">아이디 찾기</button>
						</div>
					</div>
