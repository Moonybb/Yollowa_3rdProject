...
public class ActivityReviewVo {
	...
	private int activity_Lat;
	private int activity_Lng;
	...
	public int getActivity_Lat() {
		return activity_Lat;
	}


	public void setActivity_Lat(int activity_Lat) {
		this.activity_Lat = activity_Lat;
	}


	public int getActivity_Lng() {
		return activity_Lng;
	}


	public void setActivity_Lng(int activity_Lng) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + activity_Lat;
		result = prime * result + activity_Lng;
	...
	public boolean equals(Object obj) {
		...
		if (activity_Lat != other.activity_Lat)
			return false;
		if (activity_Lng != other.activity_Lng)
			return false;
	...
	public ActivityReviewVo(int review_reviewNumber, int review_articleNumber, String review_title,
			...
			String activity_img, int activity_temp, int activity_Lat, int activity_Lng) {
		super();
		this.review_reviewNumber = review_reviewNumber;
		this.review_articleNumber = review_articleNumber;
		this.review_title = review_title;
