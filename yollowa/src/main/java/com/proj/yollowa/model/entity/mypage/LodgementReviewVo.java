...
public class LodgementReviewVo {
	...
	public LodgementReviewVo(int review_reviewNumber, int review_articleNumber, String review_title,
			...
			int lodgement_userNumber, String lodgement_companyName, String lodgement_location, double lodgement_Lat,
			double lodgement_Lng, String lodgement_category, String lodgement_hashTag, int lodgement_goodCount,
